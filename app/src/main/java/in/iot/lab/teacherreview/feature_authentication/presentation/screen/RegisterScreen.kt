...
import `in`.iot.lab.teacherreview.feature_authentication.presentation.navigation.AuthenticationRoutes.Register
import `in`.iot.lab.teacherreview.feature_authentication.presentation.stateholder.RegisterViewModel
 ...
 *
 * For Developers :-
 * The Route id of this function is [Register] as defined in the [AuthenticationRoutes] class in
    ...
    Surface(
        ...
        Column(
            ...
            ImageAndScreenHeading(
                image = R.drawable.image_registration_screen,
                screenHeader = R.string.create_an_account
            )
            ...
            UserInputUI(
                ...
                inputFieldLabel = R.string.enter_name,

                // Things the User Inputs
                userInput = myViewModel.userInputName,
                ...
                trailingIcon = {
                    if (myViewModel.userInputName != "") {
                        IconButton(onClick = { myViewModel.clearUserInputName() }) {
                            Icon(imageVector = Icons.Default.Clear, contentDescription = null)
                        }
                    }
                }
            ) {
                myViewModel.updateUserInputName(it)
            }
            ...
            UserInputUI(
                ...
                // Label in the OutlinedTextField
                inputFieldLabel = R.string.enter_phone_number,

                // Things the User Inputs
                userInput = myViewModel.userInputPhoneNumber,
                ...
                // It is the Clear Icon to be Showed as a Trailing Icon
                trailingIcon = {
                    if (myViewModel.userInputPhoneNumber != "") {
                ...
                myViewModel.updateUserInputPhoneNumber(it)
            }
            ...
            GradientButton(
                ...
                if (registrationRequestEmpty)
                    myViewModel.sendRegisterRequest()
                else
