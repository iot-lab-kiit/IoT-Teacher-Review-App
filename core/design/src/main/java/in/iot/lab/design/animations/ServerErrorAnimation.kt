...
/**
 * This composable function is used to show a server error screen with an animation.
 */
@Composable
fun ServerErrorAnimation(
    ...
    val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(R.raw.server_error))
