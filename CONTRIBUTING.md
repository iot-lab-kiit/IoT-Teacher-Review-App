# 🤝 Contributing to IoT Teacher Review App

Thank you for considering contributing to the **IoT Teacher Review App**!

We welcome contributions from developers, designers, and enthusiasts eager to enhance this application.
...
### 1. Fork the repository
 Navigate to the [IoT Teacher Review App GitHub page](https://github.com/iot-lab-kiit/IoT-Teacher-Review-App) and click the **Fork** button at the top-right corner to create your own copy.
...
```bash
git remote add upstream https://github.com/iot-lab-kiit/IoT-Teacher-Review-App.git
```
...
> We appreciate your interest in contributing to the IoT Teacher Review App!
